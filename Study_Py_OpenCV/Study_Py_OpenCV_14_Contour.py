...
import cv2
src = cv2.imread("Study_Py_OpenCV/src/contours.png", cv2.IMREAD_COLOR)
...
# cv2.findContours(이진화 이미지, 검색 방법, 근사화 방법)을 fffff의미합니다.
...
# Tip : 해당 예제는 cv2.RETR_CCOMP로 2 단계 계층 구조로만 표시합니다.
# Tip : 계층 구조를 사용하여 내곽, 외곽 윤곽선을 구분할 수 있습니다.